...
abbr -a -U -- gla 'git log --oneline --graph --all'
abbr -a -U -- gls 'git ls-files'
abbr -a -U -- gp 'git pull'
abbr -a -U -- gs 'git status'
abbr -a -U -- k kubectl
abbr -a -U -- kp 'kubectl get pods --field-selector status.phase=Pending -n'
abbr -a -U -- kr 'kubectl get pods --field-selector status.phase=Running -n'
abbr -a -U -- p2r jq\ -r\ \'.default\ \|\ to_entries\[\]\ \|\ .key\ +\ .value.version\'
abbr -a -U -- py python3
abbr -a -U -- tigb 'tig (git branch | fzf | sed "s/ //g")'
abbr -a -U -- up 'sudo apt update && apt list --upgradable'
abbr -a -U -- upg 'sudo apt upgrade'
